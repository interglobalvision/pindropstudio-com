...
Site.Media = {
  ...
  loadAudio: function($item, soundcloudUrl) {
    var _this = this;
    var insert = '<div id="media-item-audio-embed"><iframe width="100%" height="350" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=' + encodeURIComponent(soundcloudUrl) + '&amp;auto_play=true&amp;hide_related=true&amp;show_comments=false&amp;show_user=false&amp;show_reposts=false&amp;visual=true"></iframe></div>';
