...
<div class="grid-row margin-top-large margin-bottom-large">
  <?php
    render_tall_ad($ad1_image, $ad1_text, $ad1_subtitle, $ad1_link_internal, $ad1_link_external, $ad1_link_text);
    render_tall_ad($ad2_image, $ad2_text, $ad2_subtitle, $ad2_link_internal, $ad2_link_external, $ad2_link_text);
  ?>
</div>